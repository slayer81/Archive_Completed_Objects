...
This project allowed me to explore a variety of concepts from the "Automate the Boring Stuff With Python" series by Al Sweigart. I recommend it to other arm-chair Python warriors like myself.
